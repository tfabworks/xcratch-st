...
const shareTranslations = {
    'ja': {
        ...
        'xcratch-st.share.modeEditor': 'エディター',
        'xcratch-st.share.modePlayer': 'プレイヤー',
        'xcratch-st.share.cancel': 'キャンセル',
        'xcratch-st.share.execute': '共有を実行',
        'xcratch-st.share.uploading': 'クラウドにアップロード中...',
        'xcratch-st.share.uploaded': 'クラウドにアップロード完了',
        'xcratch-st.share.copy': 'コピー',
        'xcratch-st.share.copied': 'コピーしました',
        'xcratch-st.share.copyFailed': 'コピーできません',
        'xcratch-st.share.validDays': '７日間有効',
        'xcratch-st.share.validUntil': '{date} まで',
    ...
    'ja-Hira': {
        ...
        'xcratch-st.share.modePlayer': 'プレイヤー',
        'xcratch-st.share.cancel': 'キャンセル',
        'xcratch-st.share.execute': 'きょうゆうを じっこう',
        'xcratch-st.share.uploading': 'クラウドに アップロードちゅう...',
        'xcratch-st.share.uploaded': 'クラウドに アップロード かんりょう',
        'xcratch-st.share.copy': 'コピー',
        'xcratch-st.share.copied': 'コピーしました',
        'xcratch-st.share.copyFailed': 'コピーできません',
        'xcratch-st.share.validDays': '７にちかん ゆうこう',
        'xcratch-st.share.validUntil': '{date} まで',
...
export default shareTranslations;
